...
public class DeleteListExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        delete2.addColumn(Bytes.toBytes("colfam1"), Bytes.toBytes("qual1")); //只删除最新版本version的一条记录 // co DeleteListExample-3-DelColNoTS Delete the latest version only in one column.
